...
window.onload = function() {
    ...
    // Auto restore mode kasir jika terkunci
    if (isKasirLocked) {
        setRole('kasir');
    }
...
function applyBrandingUI() {
    ...
    // FOOTER LINKS, CUSTOM ICONS & MAPS
    if (document.getElementById('ft-header-title')) {
        ...
        if (document.getElementById('img-icon-grab') && store.theme.imgGrab) document.getElementById('img-icon-grab').src = store.theme.imgGrab;
        if (document.getElementById('img-icon-gofood') && store.theme.imgGoFood) document.getElementById('img-icon-gofood').src = store.theme.imgGoFood;
        if (document.getElementById('img-icon-ig') && store.theme.imgIg) document.getElementById('img-icon-ig').src = store.theme.imgIg;
        if (document.getElementById('img-icon-tiktok') && store.theme.imgTikTok) document.getElementById('img-icon-tiktok').src = store.theme.imgTikTok;
        
        if (store.theme.imgWa && store.theme.imgWa.trim() !== '') {
            if (document.getElementById('img-icon-wa')) {
                document.getElementById('img-icon-wa').src = store.theme.imgWa;
                document.getElementById('img-icon-wa').classList.remove('hidden');
            }
            if (document.getElementById('icon-wa-fa')) document.getElementById('icon-wa-fa').classList.add('hidden');
        }
...
function updateStampRuleDescription() {
    ...
    if (el) el.innerText = `Khusus Member Terdaftar. Dapatkan 1 stempel tiap min. belanja Rp ${store.stampMinSpend.toLocaleString()}!`;
}
